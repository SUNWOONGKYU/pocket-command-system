...
| **분대** | **소환된 팀원 / 사업팀 로스터** | 소대장이 즉석 소환하는 임시 조력자(백호), 또는 BuzzLab처럼 상시 등록해 둔 COO·CMO·CFO 로스터. |
| **감사관** | **검수 전용 워커** | 특정 워커의 산출물을 *자동으로* 감사하고 의견을 냄. |

> 핵심 원칙: **분대는 미리 만들지 않는다** (백호 즉석 소환 기준. 단 사업팀 로스터처럼 상시
...
> **워커 하나를 순식간에 수십 명의 AI 부대로 확장**한다.
...
### 왜 강력한가
- **폰 한 줄이 수십 AI의 동시 작전이 된다.** 콕핏에서 워커를 골라 명령 →
